...
Singleton {
  ...
  Item {
    ...
    property string barBgColor: "#aa1F1F28"  // Dragon Black
    property string buttonBorderColor: "#2A2A37"  // Dragon Gray
    property string buttonBackgroundColor: "#363646"  // Dragon Gray2
    property bool buttonBorderShadow: true
    property bool onTop: true
    property string iconColor: "#FFA066"  // Dragon Orange
    property string iconPressedColor: "#FF9E3B"  // Dragon Orange2
  }
